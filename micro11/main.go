...
func main() {
	...
	snowBall1 := ndphysics.NewProjectile(20, rl.NewVector2(0, 225), rl.NewVector2(20, 0))
	snowBall2 := ndphysics.NewProjectile(20, rl.NewVector2(800, 225), rl.NewVector2(-20, 0))
